Pod::Spec.new do |spec|
  ...
  spec.license      = 'MIT'
  spec.source       = { :git => 'https://github.com/edc1591/SLRESTfulCoreData.git', :tag => spec.version.to_s }
  spec.ios.frameworks   = 'Foundation', 'UIKit', 'CoreData'
  spec.osx.frameworks   = 'Foundation', 'AppKit', 'CoreData'
